...
sudo apt-get -y -q --no-install-recommends install texlive-latex-base texlive-fonts-recommended texlive-fonts-extra texlive-latex-extra pgf tex-gyre rubber texlive-math-extra texlive-extra-utils
